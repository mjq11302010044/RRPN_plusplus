...
def get_version():
    init_py_path = path.join(path.abspath(path.dirname(__file__)), "maskrcnn_benchmark", "__init__.py")
...
def get_extensions():
    ...
    extensions_dir = path.join(this_dir, "maskrcnn_benchmark", "layers", "csrc")
